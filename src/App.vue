            ...
            <div class="mt-1 relative rounded-md shadow-md">
              ...
              >
                <span
                  ...
                  :key="hint.id"
                  @click.stop="addTickerByHint(hint)"
                  class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer"
                >
                  {{ hint.Symbol }}
                </span>
              </div>
              <div v-show="isTickerAdded" class="text-sm text-red-600">
...
export default {
  ...
  computed: {
    isTickerAdded() {
      return this.findTicker(this.tickerUpperCase) ? true : false;
    },
    tickerUpperCase() {
  ...
  methods: {
    ...
    async updateTickers() {
      ...
      // const tickerData = await loadTickers(
